<div class="space-y-6">
    <div class="flex items-center justify-between">
        <flux:heading size="xl">{{ $collectionId ? 'Edit collection' : 'Add collection' }}</flux:heading>
        <flux:button variant="ghost" href="{{ url('/admin/collections') }}">Back</flux:button>
    </div>
    ...
    <form wire:submit="save" class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div class="space-y-4">
            ...
            <flux:button type="submit" variant="primary" class="w-full">Save collection</flux:button>
        </div>
    </form>
</div>
