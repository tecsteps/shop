<div>
    <flux:breadcrumbs class="mb-4">
        ...
        <flux:breadcrumbs.item>{{ $discount->code }}</flux:breadcrumbs.item>
    </flux:breadcrumbs>

    <div class="flex items-center justify-between mb-6">
        <flux:heading size="xl">Edit discount</flux:heading>
        <flux:text class="text-zinc-500">Used {{ $discount->times_used ?? 0 }} times</flux:text>
    </div>
