<div>
    ...
    <flux:heading size="xl" class="mb-6">Create page</flux:heading>

    <form wire:submit="save" class="space-y-6 max-w-2xl">
        <div class="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-900 space-y-4">
            <flux:field>
                <flux:label>Title</flux:label>
                <flux:input wire:model.live.debounce.500ms="title" placeholder="e.g. About us" />
                <flux:error name="title" />
            </flux:field>

            <flux:field>
                <flux:label>Handle</flux:label>
                <flux:input wire:model="handle" placeholder="e.g. about-us" />
            ...
            <flux:field>
                ...
                <flux:textarea wire:model="bodyHtml" rows="12" placeholder="Page content (HTML supported)" />
        ...
        <div class="flex items-center gap-4">
            <flux:button type="submit" variant="primary">Create page</flux:button>
