        ...
        <header class="sticky top-0 z-40 border-b border-zinc-200 bg-white/95 backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/95">
            <div class="mx-auto flex max-w-7xl items-center justify-between gap-6 px-4 py-4 sm:px-6 lg:px-8">
                ...
                <nav class="hidden items-center gap-6 text-sm font-medium md:flex" aria-label="Main navigation">
                    <a href="{{ route('collections.index') }}" class="text-zinc-600 hover:text-zinc-950 dark:text-zinc-300 dark:hover:text-white" wire:navigate>Collections</a>
                    <a href="{{ route('collections.show', 'new-arrivals') }}" class="text-zinc-600 hover:text-zinc-950 dark:text-zinc-300 dark:hover:text-white" wire:navigate>New Arrivals</a>
                    <a href="{{ route('collections.show', 't-shirts') }}" class="text-zinc-600 hover:text-zinc-950 dark:text-zinc-300 dark:hover:text-white" wire:navigate>T-Shirts</a>
                    <a href="{{ route('search.index') }}" class="text-zinc-600 hover:text-zinc-950 dark:text-zinc-300 dark:hover:text-white" wire:navigate>Search</a>
                    <a href="{{ route('pages.show', 'about') }}" class="text-zinc-600 hover:text-zinc-950 dark:text-zinc-300 dark:hover:text-white" wire:navigate>About</a>
                </nav>
        ...
        <footer class="border-t border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900">
            <div class="mx-auto grid max-w-7xl gap-8 px-4 py-10 text-sm sm:px-6 md:grid-cols-3 lg:px-8">
                <div class="space-y-2">
                    ...
                    <p class="max-w-sm text-zinc-600 dark:text-zinc-400">A self-contained demo storefront with scoped catalog data and checkout-ready products.</p>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex flex-col gap-2 text-zinc-600 dark:text-zinc-400">
                        <a href="{{ route('collections.index') }}" wire:navigate>Collections</a>
                        <a href="{{ route('collections.show', 'sale') }}" wire:navigate>Sale</a>
                        <a href="{{ route('search.index') }}" wire:navigate>Search</a>
                    </div>
                </div>
