...
@section('content')
    <div class="mb-6 flex flex-wrap items-end justify-between gap-4">
        <div>
            <h1 class="text-2xl font-semibold text-zinc-900">Edit Collection</h1>
            <p class="mt-1 text-sm text-zinc-600">{{ $collection->title }}</p>
        </div>
    ...
    <form method="POST" action="{{ route('admin.collections.update', $collection) }}" class="space-y-6">
        ...
        @include('admin.collections._form', ['collection' => $collection])
