...
<div class="w-full max-w-md rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
    ...
    <form class="mt-6 space-y-4" method="POST" action="{{ route('admin.auth.forgot-password.store') }}">
        @csrf
        <div>
    ...
    <div class="mt-4 text-sm">
        <a class="text-slate-700 hover:text-slate-900" href="{{ route('admin.auth.login') }}">Back to login</a>
    </div>
</div>
</body>
</html>
