...
Your mission is to implement an entire shop system based on the specifications im specs/*. Do not stop until all phases are complete and verified. The result is a perfect shop system. All requirements are perfectly implemented. All acceptance criteria are met, tested and confirmed by you.
...
(e) Manual verification of all features using Playwright & Chrome (non-scripted) (per phase). Url: shop.test

If specs are ambiguous, the team lead makes the call and documents the decision in progress.md.
