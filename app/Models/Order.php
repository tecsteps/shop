...
class Order extends Model
{
    ...
    /**
     * Total amount already refunded (processed refunds only) in minor units.
     */
    ...
    {
        return max(0, $this->total_amount - $this->refundedAmount());
    }

    /**
     * Whether every order line references a digital (non-shippable) variant.
     */
    public function isFullyDigital(): bool
    {
        $lines = $this->lines()->with('variant')->get();
