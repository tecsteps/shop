...
class Container_b3b4963673 extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_b3b4963673 $container)
			{
	...
	public function createServiceContainer(): Container_b3b4963673
	{
		return $this;
	}
