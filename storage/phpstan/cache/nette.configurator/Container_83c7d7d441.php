...
class Container_83c7d7d441 extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_83c7d7d441 $container)
			{
	...
	public function createServiceContainer(): Container_83c7d7d441
	{
		return $this;
	}
