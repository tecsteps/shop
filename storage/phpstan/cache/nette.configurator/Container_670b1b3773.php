...
class Container_670b1b3773 extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_670b1b3773 $container)
			{
	...
	public function createServiceContainer(): Container_670b1b3773
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'SHELL' => '/bin/zsh',
				'TERM' => 'xterm-ghostty',
				'TMPDIR' => '/var/folders/kn/sl1drbps1g7dbr_r0jmllvqh0000gn/T/',
