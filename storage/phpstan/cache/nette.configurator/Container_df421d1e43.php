...
class Container_df421d1e43 extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_df421d1e43 $container)
			{
	...
	public function createServiceContainer(): Container_df421d1e43
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'_' => '/Users/fabianwesner/Library/Application Support/Herd/bin/php84',
