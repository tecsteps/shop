...
return new class extends Migration
{
    public function up(): void
    {
        ...
        SqliteEnumCheck::add('payments', 'provider', ['mock']);
        SqliteEnumCheck::add('payments', 'method', ['credit_card', 'paypal', 'bank_transfer']);
        SqliteEnumCheck::add('payments', 'status', ['pending', 'captured', 'failed', 'refunded']);
    }
