...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("CREATE TRIGGER product_variants_status_check BEFORE INSERT ON product_variants
            BEGIN
        ...
        DB::statement("CREATE TRIGGER product_variants_status_check_update BEFORE UPDATE ON product_variants
            BEGIN
                SELECT CASE WHEN NEW.status NOT IN ('active', 'archived')
                    THEN RAISE(ABORT, 'Invalid variant status')
                END;
