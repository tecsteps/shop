...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("CREATE TRIGGER check_navigation_items_type INSERT ON navigation_items
            BEGIN
        ...
        DB::statement("CREATE TRIGGER check_navigation_items_type_update UPDATE OF type ON navigation_items
            BEGIN
                SELECT CASE WHEN NEW.type NOT IN ('link', 'page', 'collection', 'product')
                    THEN RAISE(ABORT, 'Invalid navigation item type')
                END;
    ...
    {
        DB::statement('DROP TRIGGER IF EXISTS check_navigation_items_type');
