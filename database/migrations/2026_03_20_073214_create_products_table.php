...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("CREATE TRIGGER products_status_check BEFORE INSERT ON products
            BEGIN
        ...
        DB::statement("CREATE TRIGGER products_status_check_update BEFORE UPDATE ON products
            BEGIN
                SELECT CASE WHEN NEW.status NOT IN ('draft', 'active', 'archived')
                    THEN RAISE(ABORT, 'Invalid product status')
                END;
