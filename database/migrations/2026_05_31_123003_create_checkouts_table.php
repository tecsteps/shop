...
return new class extends Migration
{
    public function up(): void
    {
        ...
        SqliteEnumCheck::add('checkouts', 'status', [
            'started', 'addressed', 'shipping_selected', 'payment_selected', 'completed', 'expired',
        ]);
        SqliteEnumCheck::add('checkouts', 'payment_method', ['credit_card', 'paypal', 'bank_transfer']);
    }
