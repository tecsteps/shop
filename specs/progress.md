...
- Order line `discount_allocations_json` now records explicit checkout discount code and discount id; automatic discount attribution still needs to be recorded before final discount reporting is complete.
