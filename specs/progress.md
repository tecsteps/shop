...
- Admin navigation persists flat ordered menu items with up/down controls because the schema has `position` but no parent/child column for nested drag-and-drop.
...
- Navigation drag-and-drop nesting is still missing; the current admin supports flat ordered menu items with up/down controls.
