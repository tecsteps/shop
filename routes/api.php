...
Route::prefix('admin/v1/stores/{storeId}')->middleware(['auth:sanctum', 'store.resolve', 'role.check:owner,admin,staff,support', 'api.ability', 'throttle:api.admin'])->group(function (): void {
    ...
    Route::get('shipping/zones', [AdminController::class, 'shippingZones']);
    ...
    Route::get('tax/settings', [AdminController::class, 'taxSettings']);
    ...
    Route::post('search/reindex', [AdminController::class, 'reindex'])->middleware('role.check:owner,admin,staff');
    Route::get('search/status', [AdminController::class, 'searchStatus']);
    Route::get('analytics/summary', [AdminController::class, 'analyticsSummary']);
